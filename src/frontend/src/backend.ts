...
export class Backend implements backendInterface {
    ...
    async getAllForms(): Promise<Array<FormSubmission>> {
        if (this.processError) {
            try {
    ...
    async getFilteredFormsByTimestamp(arg0: bigint): Promise<Array<FormSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilteredFormsByTimestamp(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchFormsByName(arg0: string): Promise<Array<FormSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchFormsByName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchFormsByServiceType(arg0: string): Promise<Array<FormSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchFormsByServiceType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
